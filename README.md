...
[![Coverage](https://github.com/gh-workflow/multiarch-image-publish/releases/latest/download/coverage.png)](https://github.com/gh-workflow/multiarch-image-publish/releases/latest)
...
- name: Publish MultiArch Image
  id: publish
  uses: gh-workflow/multiarch-image-publish@0.1.3
  with:
